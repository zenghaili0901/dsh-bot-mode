...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function IconPlus() { return h(primitives.IconPlusOutline16, { size: 13 }); }
    function IconMinus() { return h(primitives.IconTrashOutline16, { size: 13 }); }
