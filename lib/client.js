...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".bm-msg-user{align-self:flex-end;background:linear-gradient(135deg,var(--dsw-alias-brand-primary),#7b5cff);color:#fff;border-bottom-right-radius:3px}",
      ...
      ".bm-btn{border:1px solid transparent;background:linear-gradient(135deg,var(--dsw-alias-brand-primary),#7b5cff);color:#fff;border-radius:8px;padding:7px 13px;font-size:12px;cursor:pointer;font-weight:600}",
