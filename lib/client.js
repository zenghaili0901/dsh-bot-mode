...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".bm-result{display:flex;align-items:center;gap:8px;padding:7px 9px;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-layer-1);cursor:pointer}",
        ...
        searching
          ...
          : (bots.length === 0
              ...
              : h("div", { className: "bm-grid" },
                  ...
                  /* trailing "new" chip — last slot in the grid */
