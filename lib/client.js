...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /* ---------------- styles (DeepSeek blue-violet glass, theme-aware) ---------------- */
    const css = [
      /* overlay docks to the LEFT, next to the sidebar, like a panel sibling */
      ".bm-overlay{position:fixed;left:266px;top:16px;bottom:16px;width:420px;max-height:none;display:flex;flex-direction:column;border:1px solid var(--dsw-alias-border-l2);border-radius:16px;background:color-mix(in srgb,var(--dsw-alias-bg-layer-2) 88%,transparent);backdrop-filter:blur(20px);box-shadow:0 12px 40px rgba(2,6,20,.25);z-index:9999;overflow:hidden;pointer-events:auto;font-size:13px;color:var(--dsw-alias-label-primary)}",
      ".bm-overlay-head{display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-bottom:1px solid var(--dsw-alias-border-l1);background:linear-gradient(120deg,color-mix(in srgb,var(--dsw-alias-brand-primary) 14%,transparent),color-mix(in srgb,#7b5cff 10%,transparent))}",
      ...
      ".bm-bot{display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid var(--dsw-alias-border-l1);border-radius:12px;background:var(--dsw-alias-bg-layer-1);cursor:pointer;transition:background .15s}",
      ".bm-bot:hover{background:var(--dsw-alias-interactive-bg-hover)}",
      ".bm-bot-emoji{font-size:22px;width:34px;height:34px;display:flex;align-items:center;justify-content:center;border-radius:50%;background:linear-gradient(135deg,color-mix(in srgb,var(--dsw-alias-brand-primary) 35%,transparent),color-mix(in srgb,#7b5cff 35%,transparent));flex:none}",
      ".bm-bot-name{font-weight:600;font-size:13px;color:var(--dsw-alias-label-primary)}",
      ".bm-bot-persona{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px;margin-top:2px;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}",
      ...
      ".bm-btn{border:1px solid transparent;background:linear-gradient(135deg,#4d6bfe,#7b5cff);color:#fff;border-radius:10px;padding:7px 14px;font-size:12px;cursor:pointer;font-weight:600}",
      ...
      ".bm-emoji-pick button{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;font-size:16px;padding:3px 7px;cursor:pointer}",
      ".bm-emoji-pick button.sel{background:linear-gradient(135deg,#4d6bfe,#7b5cff);border-color:transparent}",
      /* sidebar entry — readable in BOTH themes via alias tokens */
      ...
      ".bm-card-desc strong{color:var(--dsw-alias-brand-primary)}",
