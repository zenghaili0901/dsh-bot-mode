...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function BotAvatar(props) {
      ...
      const sz = size || 36;
      if (emoji && !icon) {
        return h("span", { className: className || "bm-chip-avatar", style: Object.assign({}, avatarBg(color), { fontSize: sz * 0.5 }) }, emoji);
      }
      return h("span", { className: className || "bm-chip-avatar", style: Object.assign({}, avatarBg(color), { color: "#fff" }) },
